...
const Projects=() => {
    return (
        <div className="px-16 mx-10 my-10 font-mono md-mx:px-6" id="Projects" >
            <h1 className="text-4xl sm-mx:text-3xl xs-mx:text-2xl text-center mb-5 font-bold text-white " ><span className="text-primaryColor">02.&nbsp;</span>Projects</h1>
