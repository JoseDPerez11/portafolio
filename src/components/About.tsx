...
const About=() => {
    ...
    return (
        <>
            <div data-aos="zoom-out-up" data-aos-duration="800" className="flex relative overflow-hidden justify-around items-center font-mono px-16 h-[80vh]" id="bg" >
                <Particles
                ...
                <div className="ml-20 w-3/5 flex flex-col" >
                    ...
                    <div className="flex gap-3">
                        <Button onClick={open} className="focus-visible:!outline-none !text-bgColor !w-fit" size="lg" variant="filled" color="#64FFDA">
                            Check Resume
                        </Button>
                        <Button component="a" href="/Marshal Resume.pdf" download={Info.name} className="focus-visible:!outline-none !text-primaryColor !w-fit" size="lg" variant="outline" color="#64FFDA" rightSection={<IconDownload size={20} />}>
                            Download
                        </Button>
                    </div>
                </div>
