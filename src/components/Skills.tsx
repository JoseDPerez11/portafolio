...
const Skills=() => {
    return <div className="px-16 md-mx:px-6 mx-10 my-10 font-mono" id="Skills" >
        ...
        <div className="flex flex-wrap gap-5 justify-around md-mx:justify-between sm-mx:justify-center gap-4 md-mx:gap-2" >
            {
